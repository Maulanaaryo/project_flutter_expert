...
class TvSeriesRepositoryImpl implements TvRepository {
  ...
  @override
  Future<Either<Failure, String>> saveWatchlistTvSeries(TvSeriesDetail tv) async {
    try {
      final result =
  ...
  @override
  Future<Either<Failure, String>> removeWatchlistTvSeries(TvSeriesDetail tv) async {
    try {
      final result =
