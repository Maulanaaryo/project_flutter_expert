...
void main() {
  const apiKey = 'api_key=d29ee1be9469b67855e4d2dc664c2e80';
  const baseUrl = 'https://api.themoviedb.org/3';

  late TvsRemoteDataSourceImpl dataSourcetv;
  late MockHttpClient mockHttpClient;

  setUp(() {
    mockHttpClient = MockHttpClient();
    dataSourcetv = TvsRemoteDataSourceImpl(client: mockHttpClient);
  });
