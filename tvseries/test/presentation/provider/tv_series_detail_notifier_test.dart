...
void main() {
  ...
  late MockGetRecommendationsTvSeries mockGetTvRecommendations;
  ...
  setUp(() {
    ...
    mockGetTvRecommendations = MockGetRecommendationsTvSeries();
    ...
    provider = TvSeriesDetailNotifier(
      getDetailTvSeries: mockGetTvDetail,
      getRecommendationsTvSeries: mockGetTvRecommendations,
  ...
  group('Get Tv Recommendations', () {
    ...
    test('should update error message when request in successful', () async {
      ...
      await provider.fetchTvDetail(tId);
      // assert
      expect(provider.recommendationTvState, RequestState.HasError);
  ...
  group('on Error', () {
    test('should return error when data is unsuccessful', () async {
      ...
      await provider.fetchTvDetail(tId);
      // assert
      expect(provider.tvState, RequestState.HasError);
